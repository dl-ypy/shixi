	...
	<tbody>
	    <s:iterator value="list" var="data">
			<tr onMouseOut="this.bgColor=''" onMouseOver="this.bgColor='#DFEfFf'">
				<td nowrap="nowrap" onclick="table1click('<s:property value="ORG_ID"/>' , '<s:property value="ORG_NAME"/>' )" width="10%" align="left" class="part1Table" id="part1Table<s:property value="ORG_ID"/>" style="border-right: 1px solid #D61821;">
