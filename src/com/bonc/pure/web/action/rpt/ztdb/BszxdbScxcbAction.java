...
public class BszxdbScxcbAction extends CwCommon {
	...
	public String table() {
		...
		list = daoHelper.queryForList("cw.rpt.ztdb.BszxdbScxcbTable", this);
		if ("-1".equals(kpiId)) {
			return "table";
		} else {
			return "tableDrill";
	...
	public void chart() {
		...
		year = thisYear;
		List line1List = daoHelper.queryForList("cw.rpt.ztdb.BszxdbScxcbLine", this);
		map.put("thisYearLine", line1List);
		year = lastYear;
		List line2List = daoHelper.queryForList("cw.rpt.ztdb.BszxdbScxcbLine", this);
		map.put("lastYearLine", line2List);
		returnMapAsJson(map);
	}
	
	public String queryDrillTableByOrg() {
		list = daoHelper.queryForList("cw.rpt.ztdb.table_queryDrillTableByOrg_BS", this);
		return "tableDrill";
	}
