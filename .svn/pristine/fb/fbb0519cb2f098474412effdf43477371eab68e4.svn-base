 ...
 *
 */
public class AnalysisChangesAction extends CwCommon {
	...
	public String getTableList() {
		list = daoHelper.queryForList("cw.rpt.xjlts.yyqkfx.getChangeTableList", this);
		return "table";
	}
	public String getTableDetail() {
		// 默认每页20条，可以在pagiParam定义时直接设置，也可以通过setPageSize设置
		pagiParam.setPageSize(18);
		list = daoHelper.queryForPagiList("cw.rpt.xjlts.yyqkfx.getChangeTableDetailList", this);
		return "tableDetail";
	}
	public void getMapChart() {
		Map<String, List<?>> map = new HashMap<String, List<?>>();
		List<?> mapList = daoHelper.queryForList("cw.rpt.xjlts.yyqkfx.getMapChart", this);
	...
	public void getWarnText(){
		Map<String, List<?>> map = new HashMap<String, List<?>>();
		List<?> mapList = daoHelper.queryForList("cw.rpt.xjlts.yyqkfx.getWarnText", this);
		map.put("mapList", mapList);
		
		List<?> mapListAdd = daoHelper.queryForList("cw.rpt.xjlts.yyqkfx.getWarnText_", this);
