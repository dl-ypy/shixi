...
(function ($) {
	...
	$.jqPagination = function (el, options) {
		...
		base.$input = base.$el.find('input:eq(1)');
		base.$input2 = base.$el.find('input:eq(0)');
		...
		base.init = function () {
			...
			base.updateInput(true);
			 ...
			 //***************
			// BIND EVENTS
			base.$input2.on('keydown.jqPagination', function (event) {
				if (event.keyCode == 13) {
					//alert("cqj");
					//alert(current_page);
					//page = parseInt(base.$input.val(),10);
					base.options.pageSized(base.options.current_page,base.$input2.val());
					base.setInputValue(base.options.current_page);
			    };
			});
