...
<table class="grid" style="width:99%;" >
	...
	<tbody>
	    <s:iterator value="list" var="data">
			<tr class="bonc_tj" onMouseOut="this.bgColor=''" onMouseOver="this.bgColor='#DFEfFf'"
				<s:if test="RST5 == 1">
					style="border-top: 2px solid #FF7F7F;"
				</s:if>
			>
				<td nowrap="nowrap" width="16%" align="left" >
					<a href='###' onclick="part1TableClick('<s:property value="KPI_ID"/>', '<s:property value="KPI_NAME"/>')"><s:property escapeHtml="false" value="KPI_NAME_SHOW"/></a>
				</td>
