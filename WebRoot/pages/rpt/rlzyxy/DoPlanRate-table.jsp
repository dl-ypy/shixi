...
<table class="grid" style="width:99%;" >
	<thead>
		<tr>
			...
			<th align="center" colspan="4" >劳动生产率</th>
		</tr>
		<tr>
			<th align="center" nowrap="nowrap">劳动生产率</th>
    ...
    <tbody>
	    <s:iterator value="list" var="data">
			<tr>
				...
				<!--劳动生产率-->
				<td align="right" width="7%"><s:property escapeHtml="false" value="KPI_01"/>%</td>
				<!--目标  -->
				<td align="right" width="7%"><s:property escapeHtml="false" value="KPI_02"/>%</td>
				<!--完成比例(年化)  -->
