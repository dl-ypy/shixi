	...
	<tbody>
	    <s:iterator value="list" var="data">
			...
			>
				...
				<td style="text-align: center;width: 25px;cursor: pointer;border-right: 1px solid #D61821;" onclick="drillTableByOrg(this, '<s:property value="KPI_ID"/>', '<s:property value="ORG_ID"/>')" onmouseover="dyo_mouseOver(this)" onmouseout="dyo_mouseOut(this)">
