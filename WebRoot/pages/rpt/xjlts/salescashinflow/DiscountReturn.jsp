  ...
  <body>
    <div class="container" style="width: 98%;margin-top: 5px;height: 0px;">
	 ...
	 <div class="container" style="width: 98%;margin-top: 2%;" id="homeframe-container">
		...
		<div class="row">
			<div class="col-xs-7 col-sm-7 col-md-7" id="tableDiv"></div>
			<div class="col-xs-5 col-sm-5 col-md-5" id="lineDiv" style="height: 380px; margin-top: 25px; padding:10px;"></div>
		</div>
	</div>
  </body>
</html>
