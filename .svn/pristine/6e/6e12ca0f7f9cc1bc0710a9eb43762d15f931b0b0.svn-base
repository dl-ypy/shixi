...
<script type="text/javascript">
	...
	function querytitle1(){
		...
		jQuery.ajax({
	 		url: '<%=contextPath%>/rpt/rlzyxy/DoPlanTrim!queryTitle2.action',
	 	    type: "POST",
	 	    data: {
	 			"monthId": monthId
	 		},
    ...
    function querytable1(){
    	...
    	monthId = jQuery("#monthId").val();
    	jQuery.ajax({
    		url: '<%=contextPath%>/rpt/rlzyxy/DoPlanTrim!queryTable2.action',
    		type:"POST",
    	    data: {
    	    	"monthId": monthId
    		},
    ...
    function getBarChart1(){
		jQuery.ajax({
			url: '<%=contextPath%>/rpt/rlzyxy/DoPlanTrim!queryBar2.action',
			type:"POST",
		    data: {
				"monthId": monthId
			},
    ...
    function getSubList(obj,regionId){
		jQuery.ajax({
			url: '<%=contextPath%>/rpt/rlzyxy/DoPlanTrim!queryLine2.action',
			type:"POST",
		    data: {
				"monthId": monthId,
				"areaNo":regionId
    ...
    <div class="container" style="width: 98%;margin-top: 5px;height: 0px;">
	 ...
	 <div class="container" style="width: 98%;margin-top: 2%;" id="homeframe-container">
		...
		<div class="row" style="text-align: left;margin-left:5px;font-weight: bold;font-size: 14px;padding-top:1%;">
		    <span id="partdiv1"></span>月，全省百万人工成本创利为 <span id="part1">---</span>万人，目标完成率<span id="part2">---</span>%<br>
		</div>
