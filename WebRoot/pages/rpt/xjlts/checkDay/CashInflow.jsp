...
var projectPath = "<%=contextPath%>";
	 ...
	 function query(){
	 	...
	 	jQuery.ajax({
	 		url: '<%=contextPath%>/rpt/xjlts/checkDay/CashInflow!queryTable.action',
	 	    type: "post",
	 	    data: {
	 			"monthId": monthId, 
	 			"areaNo": areaNo
	   ...
	   function getSubList(obj, region_id){
		    var monthId = jQuery('#monthId').val();
			var url= '<%=contextPath%>/rpt/xjlts/checkDay/CashInflow!queryTableDrill.action';
...
<body>
	 ...
	 <div class="container" style="width: 98%;margin-top:30px;" id="homeframe-container">
			...
			<div class="col-xs-12 col-sm-12 col-md-12" style="padding: 0px;">
				<table style="border-collapse: collapse;height: 28px;padding: 0px;margin: auto;width: 100%;">
					...
					<td style="background-color: #BFBFBF;text-align: left;padding-left: 10px;font-weight: bold;font-size: 14px;">基层销售单元销售现金流入报表</td>
					</tr>
				</table>
			</div>
		</div>
