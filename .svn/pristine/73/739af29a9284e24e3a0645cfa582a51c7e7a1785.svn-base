...
<script type="text/javascript">
    function initRingChart(){
		...
		jQuery.ajax({
			url: '<%=path%>/rpt/ztdb/BdZtqk!initRingChart.action',
			type:"POST",
		    data: {
				"monthId": monthId, 
				"areaNo": areaNo
    ...
    function loadNowYearStackChart(){
    	...
    	var url = '<%=basePath%>/rpt/ztdb/BdZtqk!initNowStackChart.action';
    	jQuery.ajax({
	 	       url: url,
	 	       type: "post",
	 	       data: parmater,
    ...
    function loadNowYearTable(){
    	...
    	var url = '<%=basePath%>/rpt/ztdb/BdZtqk!initNowTable.action';
    ...
    function loadLastYearStackChart(){
    	...
    	var url = '<%=basePath%>/rpt/ztdb/BdZtqk!initLastStackChart.action';
    	jQuery.ajax({
	 	       url: url,
	 	       type: "post",
	 	       data: parmater,
    ...
    function loadLastYearTable(){
    	...
    	var url = '<%=basePath%>/rpt/ztdb/BdZtqk!initLastTable.action';
