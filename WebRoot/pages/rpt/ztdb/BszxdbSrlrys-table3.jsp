...
<table class="grid" style="width:99%;" >
	<thead>
		<tr>
			...
			<th width="8%" align="center" style="border-right: 1px solid #D61821;">环比增长</th>
	...
	<tbody>
	    <s:iterator value="list" var="data">
			<tr onMouseOut="this.bgColor=''" onMouseOver="this.bgColor='#DFEfFf'">
				<td nowrap="nowrap" onclick="table3click('<s:property value="ORG_ID"/>' , '<s:property value="ORG_NAME"/>' )" width="10%" align="left" class="part3Table" id="part3Table<s:property value="ORG_ID"/>" style="border-right: 1px solid #D61821;">
				...
				<td align="center" width="8%" style="border-right: 1px solid #D61821;"><s:property escapeHtml="false" value="%{kpiFmt(KPI_02,'###,###,##0')}" /></td>
