			...
			<tr onMouseOut="this.bgColor=''" onMouseOver="this.bgColor='#DFEfFf'">
				...
				<s:else>
					<td nowrap="nowrap" width="9%" align="left" >
						...
						<a href='###'  onclick="tableClick('<s:property value="KPI_ID"/>' , '<s:property value="KPI_NAME"/>', '<s:property value="ORG_ID"/>' )" class="part1Table"><s:property escapeHtml="false" value="KPI_NAME"/><s:property value="DOWM"/></a>
					</td>
				</s:else>
				<s:if test="DOWN== 'ORG'">	
