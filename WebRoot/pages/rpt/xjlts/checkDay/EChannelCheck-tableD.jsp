    ...
    <tbody>
	    <s:iterator value="list" var="data">
			<tr onMouseOut="this.bgColor=''" onMouseOver="this.bgColor='#DFEfFf'">
			    <s:if test="DEPART_ID == 'root'">
					<td nowrap="nowrap" width="7%" align="left"><s:property escapeHtml="false" value="DEPART_NAME"/></td>
			    </s:if>
			    <s:else>
					<td id='bisKpiTreeRootORG_${DEPART_ID}' nowrap="nowrap" onclick="getSubList(this, '${DEPART_ID}')" width="7%" align="left"><img id='IMG_${DEPART_ID }' src="<%=contextPath%>/resources/frame/DrillTable/icon-right.png" width="17" height="17" border="0"  class="topTableTr" />&nbsp;<a href='###'><s:property escapeHtml="false" value="DEPART_NAME"/></a></td>
			    </s:else>
