...
public class BszxdbSywcqkAction extends CwCommon {
	...
	public String table() {
		...
		list = daoHelper.queryForList("cw.rpt.ztdb.BszxdbSywcqkTable", this);
		if ("-1".equals(kpiId)) {
			return "table";
		} else {
			return "tableDrill";
...
public String getOrgTable(){
	list = daoHelper.queryForList("cw.rpt.ztdb.BszxdbSywcqkOrgTable", this);
	return "tableDrill";
}
	public void chart() {
		Map map = new HashMap();
		...
		year = thisYear;
		List line1List = daoHelper.queryForList("cw.rpt.ztdb.BszxdbSywcqkLine", this);
		map.put("thisYearLine", line1List);
		year = lastYear;
		List line2List = daoHelper.queryForList("cw.rpt.ztdb.BszxdbSywcqkLine", this);
