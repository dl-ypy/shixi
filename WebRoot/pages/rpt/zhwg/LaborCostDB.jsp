...
<script type="text/javascript">
	...
	function querytitle(){
		...
		jQuery.ajax({
	 		url: '<%=contextPath%>/rpt/zhwg/LaborCostDB!querytitle.action',
	 	    type: "POST",
	 	    data: {
	 			"monthId": monthId,
	 			"areaNo": 'root'
	...
	function querytable(){
	 	...
	 	jQuery.ajax({
	 		url: '<%=contextPath%>/rpt/zhwg/LaborCostDB!queryOutTable.action',
	 	    type: "POST",
	 	    data: {
	 			"monthId": monthId,
	 			"areaNo": areaNo
	...
	function queryChart(){
		var monthId = jQuery('#monthId').val();
		jQuery.ajax({
			url: '<%=contextPath%>/rpt/zhwg/LaborCostDB!queryOutChart.action',
			type:"POST",
		    data: {
				"monthId": monthId
			},
	 ...
	 <div class="container" style="width: 98%;margin-top: 2%;" id="homeframe-container">
			...
			<div class="col-xs-12 col-sm-12 col-md-12" style="padding: 0px;">
				<table style="border-collapse: collapse;height: 28px;padding: 0px;margin: auto;width: 100%;">
					<tr>
						...
						<td style="background-color: #BFBFBF;text-align: left;padding-left: 10px;font-weight: bold;font-size: 14px;">人工成本增幅对标</td>
					</tr>
				</table>
			</div>
		</div>
		<div class="row" style="text-align: left;margin-left:5px;font-weight: bold;font-size: 14px;padding-top:1%;">
			<!-- 
			 ...
			 -->
			 1月，全省综合网格人工成本完成较基数增幅XX%，全省整体人工成本较基数增幅XX%，综合网格人工成本增幅较整体高（低）XXpp。
		</div>
		<div class="row">
