...
function table1() {
	jQuery.ajax({
		url: '<%=contextPath%>/rpt/ztdb/BszxdbSrlrys!table1.action',
		type:"POST",
	    data: {
			"monthId": monthId
		},
...
function table1click(orgId, chartName) {
	jQuery.ajax({
		url: '<%=contextPath%>/rpt/ztdb/BszxdbSrlrys!chart1.action',
		type:"POST",
	    data: {
			"monthId": monthId,
			"orgId": orgId
...
function table2() {
	jQuery.ajax({
		url: '<%=contextPath%>/rpt/ztdb/BszxdbSrlrys!table2.action',
		type:"POST",
	    data: {
			"monthId": monthId
		},
...
function table2click(orgId, chartName) {
	jQuery.ajax({
		url: '<%=contextPath%>/rpt/ztdb/BszxdbSrlrys!chart2.action',
		type:"POST",
	    data: {
			"monthId": monthId,
			"orgId": orgId
...
function table3() {
	jQuery.ajax({
		url: '<%=contextPath%>/rpt/ztdb/BszxdbSrlrys!table3.action',
		type:"POST",
	    data: {
			"monthId": monthId
		},
...
function table3click(orgId, chartName) {
	jQuery.ajax({
		url: '<%=contextPath%>/rpt/ztdb/BszxdbSrlrys!chart3.action',
		type:"POST",
	    data: {
			"monthId": monthId,
			"orgId": orgId
