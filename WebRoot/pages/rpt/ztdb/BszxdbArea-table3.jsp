...
<table class="grid" style="width:99%;" >
	<thead>
		<tr>
			<th width="10%" align="center" style="border-right: 1px solid #D61821;">单位</th>
	...
	<tbody>
	    <s:iterator value="list" var="data">
			<tr onMouseOut="this.bgColor=''" onMouseOver="this.bgColor='#DFEfFf'">
				<td nowrap="nowrap" onclick="table3click('<s:property value="AREA_NO"/>' , '<s:property value="AREA_DESC"/>' )" width="10%" align="left" class="part3Table" 
				    id="part3Table<s:property value="AREA_NO"/>" style="border-right: 1px solid #D61821;">
