...
<script type="text/javascript">
    ...
    function table() {
    	jQuery.ajax({
    		url: '<%=contextPath%>/rpt/xjlts/salescashinflow/InflowReport!table.action',
    		type:"POST",
    	    data: {
    			"areaNo":areaNo,
    	    	"monthId": monthId
	 	...
	 	<div class="row" style="height: 30px;margin-top: 10px;">
			<div class="col-xs-12 col-sm-12 col-md-12" style="padding: 0px;">
				<table style="border-collapse: collapse;height: 28px;padding: 0px;margin: auto;width: 100%;">
					...
					<td style="background-color: #BFBFBF;text-align: left;padding-left: 10px;font-weight: bold;font-size: 14px;">销售现金流入报表</td>
					</tr>
				</table>
			</div>
		</div>
