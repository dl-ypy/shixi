	    ...
	    <s:iterator value="list" var="data">
			...
			>
				<s:if test="HAVE_CHILDREN == 1">
					<td nowrap="nowrap" id='bisKpiTreeRootORG_${KPI_ID}' onclick="queryTableDrill(this, '<s:property value="KPI_ID"/>', '<s:property value="ORG_ID"/>')"  width="6%" align="left">
				...
				<td style="text-align: center;width: 10px;cursor: pointer;border-right: 1px solid #D61821;" onclick="drillTableByOrg(this, '<s:property value="KPI_ID"/>', '<s:property value="ORG_ID"/>')" onmouseover="dyo_mouseOver(this)" onmouseout="dyo_mouseOut(this)">
